    ...
    <Screen>
      ...
      <View className="w-full gap-4 px-6 pt-2">
        <View className="h-[392px] w-full items-center justify-center gap-[18px] rounded-[20px] bg-[#1a1a1a] p-6">
          <View className="h-[158px] w-[250px] items-center justify-center rounded-2xl border-2 border-dashed border-primary">
            <IdCard size={44} color="#ffffff" strokeWidth={1.5} />
          </View>
